...
const TOP_ITEMS: NavItem[] = [
  ...
  { to: '/acesso-pendente', label: 'Liberações de acesso', icon: 'shield', roles: ['ANALISTA', 'CEO', 'DIRETOR_COMERCIAL', 'DIRETOR_FINANCEIRO', 'DIRETOR_JURIDICO', 'ASSESSORA_MARKETING'] },
  ...
  // Aba "Sem Fila" REMOVIDA: a Base Imobiliária já cumpre esse papel (lead sem fila
  // cai na base, marketing direciona) — sem o risco de corretor ver lead alheio.
  ...
  { to: '/pipeline', label: 'Funil', icon: 'pipeline', roles: [...COMERCIAL, 'CORRETOR', SOCIO, 'GESTOR_MARKETING'] },
  { to: '/vendas', label: 'Vendas', icon: 'sales', roles: [...COMERCIAL, 'CORRETOR', 'DIRETOR_FINANCEIRO', 'FINANCEIRO', 'DIRETOR_JURIDICO', 'ADMINISTRATIVO', SOCIO, 'GESTOR_MARKETING'] },
  { to: '/minhas-comissoes', label: 'Minhas Comissões', icon: 'wallet', roles: ['CORRETOR', 'GERENTE_EQUIPE', 'CEO', 'GESTOR_MARKETING'] },
  { to: '/analise-vendas', label: 'Análise de Vendas', icon: 'chart', roles: ['CEO', 'DIRETOR_COMERCIAL', 'DIRETOR_FINANCEIRO', 'FINANCEIRO'] },
...
const GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { to: '/equipes', label: 'Equipes', icon: 'team', roles: ['CEO', 'DIRETOR_COMERCIAL', 'DIRETOR_FINANCEIRO', 'MARKETING', SOCIO, 'GERENTE_EQUIPE', 'GESTOR_MARKETING', 'ASSESSORA_MARKETING'] },
      ...
      { to: '/fila-ao-vivo', label: 'Fila ao vivo', icon: 'clock', roles: ['CEO', 'DIRETOR_COMERCIAL', 'MARKETING', 'GERENTE_EQUIPE', 'SOCIO_UNIDADE'] },
      { to: '/filas-disparo', label: 'Filas de Disparo', icon: 'send', roles: ['CEO', 'DIRETOR_COMERCIAL', 'MARKETING', 'GESTOR_MARKETING'] },
      ...
      { to: '/leads?base=3', label: 'Base Imobiliária', icon: 'database', roles: ['CEO', 'DIRETOR_COMERCIAL', 'MARKETING', 'GESTOR_MARKETING'] },
      ...
      { to: '/biblioteca', label: 'Biblioteca (gestores)', icon: 'scroll', roles: ['CEO', 'DIRETOR_COMERCIAL', 'DIRETOR_FINANCEIRO', 'DIRETOR_JURIDICO', 'GERENTE_EQUIPE', 'SOCIO_UNIDADE', 'ADMINISTRATIVO', 'MARKETING', 'GESTOR_MARKETING', 'GESTOR_TRAFEGO', 'ASSESSORA_MARKETING', 'ASSESSORA'] },
    ],
  },
  {
    key: 'financeiro',
    ...
    icon: 'wallet',
    items: [
      { to: '/painel-financeiro', label: 'Painel do Diretor', icon: 'dashboard', roles: DIR_FINANCE },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/enviar-notificacao', label: 'Enviar notificação', icon: 'send', roles: ['CEO', 'DIRETOR_COMERCIAL', 'MARKETING', 'GESTOR_MARKETING'] },
