...
const COR_FUNIL: Record<string, string> = {
  NOVO: '#8493B4', SDR: '#8493B4', NAO_RESPONDE: '#C77', LISTA_VIP: '#9B59B6',
  EM_ATENDIMENTO: '#0E7C9B', QUALIFICANDO: '#0E7C9B', FLUXO: '#3FB6D4', PAROU_RESPONDER: '#8896AB', POS_FLUXO: '#2A93AE',
  VISITA: '#5BC0DE', NEGOCIANDO: '#F2B544', PROPOSTA: '#E08e1a',
  FECHADO: '#88C559', VENDIDO: '#88C559', GANHO: '#88C559',
