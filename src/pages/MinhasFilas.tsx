                ...
                {f.pausado ? (
                  ...
                  <>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                      ...
                      <span className="text-xs text-secondary">na fila</span>
                    </div>
                    <div style={{ marginTop: 6, fontSize: 13, fontWeight: 700, color: proximo ? '#16A34A' : 'var(--text-primary)' }}>
                      {proximo ? 'Você é o PRÓXIMO a receber!' : 'Continue atento — sua vez vai chegar'}
                    </div>
                    <div className="text-xs text-secondary" style={{ marginTop: 4 }}>
                      A cada lead que entra, quem recebe vai pro fim e você sobe uma posição.
                    </div>
                  </>
                )}
              </div>
